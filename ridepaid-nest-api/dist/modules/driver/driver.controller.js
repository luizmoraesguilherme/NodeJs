        ...
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.driverService.all(name, page, size).then((drivers) => {
                return drivers.map(driver => {
                    let driverDto = new driver_list_dto_1.DriverListDto(driver.id, driver.name, driver.licenseType);
                    if (driver.cars) {
    ...
    getDriverByName(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.driverService.driverById(id).then((driver) => {
                if (driver_domain_1.Driver) {
                    return new driver_list_dto_1.DriverListDto(driver.id, driver.name, driver.licenseType);
                }
                else {
                    throw new common_1.NotFoundException(`Não existe motorista com o id ${id}`);
                }
            });
        });
    }
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], DriverController.prototype, "getDriverByName", null);
__decorate([
